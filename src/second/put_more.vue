    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <div class="zuo">
          ...
          <p id="watch_num" style="color:red">浏览量：2000</p>
      ...
      <div class="right">
        ...
        >
          ...
          <div v-if="item.commentList.length<2">
            <div
              class="comment"
              ...
              :key="reply.lilindex"
            >
              <span>{{reply.userName}}回复{{item.userName}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{reply.commentTime}}</span>
          ...
          <div v-else>
            <div v-if="!item.replyState" key="1">
              ...
              <button
                class="reply_btn"
                style="font-size:16px;margin-left:370px"
                @click="change_reply(index)"
              >点击收起</button>
            </div>
            <div v-else class="comment" key="2">
              <span>{{item.commentList[0].userName}}回复{{item.userName}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{item.commentList[0].commentTime}}</span>
              ...
              >删除</el-button>
              <button
                style="font-size:16px;margin-left:270px"
                class="reply_btn"
                @click="change_reply(index)"
              >查看全部</button>
            </div>
